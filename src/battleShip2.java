	...
	public static void hitOrMiss(){//game play
		...
		while(notWon == true){
			...
			//if it is the npc's turn
				...
				//cast or force a num to be a type that it isn't
				int randomGuessOne = (int)(Math.random()*9);//y coordinate
				int randomGuessTwo = (int)(Math.random()*9);//x coordinate
				
				playerTwoTopBoard[randomGuessOne][randomGuessTwo] = "boo";
				}//end of print board
			
				if (playerTwoBoard[randomGuessOne][randomGuessTwo].equals("poo")){
